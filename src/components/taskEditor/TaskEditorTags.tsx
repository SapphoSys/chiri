      ...
      >
        ...
        {!readOnly && (
          <button
            ...
            className="box-border inline-flex h-6.5 items-center gap-1 rounded-sm border border-surface-200 bg-surface-50 px-2 text-surface-700 text-xs leading-none outline-hidden transition-colors hover:border-surface-400 focus-visible:ring-2 focus-visible:ring-primary-ink focus-visible:ring-inset dark:border-surface-600 dark:bg-surface-800 dark:text-surface-300 dark:hover:border-surface-500"
          >
