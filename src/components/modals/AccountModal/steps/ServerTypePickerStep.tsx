...
const CATEGORIES: ServerTypeCategory[] = [
  ...
  },
  {
    ...
    iconBg: 'bg-primary-500/15 text-primary-ink',
    servers: [
          ...
          <div className="grid grid-cols-3 gap-2">
            {category.servers.map((server) => (
              ...
              >
                ...
                <ArrowRight className="size-3.5 shrink-0 text-surface-300 transition-colors group-hover:text-primary-ink dark:text-surface-500 dark:group-hover:text-primary-400" />
              </button>
            ))}
          </div>
        </div>
