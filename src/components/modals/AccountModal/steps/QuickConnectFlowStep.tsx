...
export interface QuickConnectFlowStepHandle {
  connect: () => void;
  cancel: () => void;
}

interface QuickConnectFlowStepProps {
...
const CONFIG = {
  nextcloud: {
    ...
    syncWhere: 'QuickConnectFlowStep.nextcloud',
  },
  rustical: {
    label: 'RustiCal',
    ...
    syncWhere: 'QuickConnectFlowStep.rustical',
  },
};

export const QuickConnectFlowStep = forwardRef<
  QuickConnectFlowStepHandle,
  QuickConnectFlowStepProps
...
QuickConnectFlowStep.displayName = 'QuickConnectFlowStep';
