...
export const AboutSettingsSection = ({ title, children }: AboutSettingsSectionProps) => (
  <div className="space-y-2">
    ...
    <div className="divide-y divide-surface-100 overflow-hidden rounded-lg border border-surface-300 bg-white dark:divide-surface-700 dark:border-surface-700 dark:bg-surface-800">
      {children}
    </div>
  </div>
);
