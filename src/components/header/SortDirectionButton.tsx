...
export const SortDirectionButton = ({
  ...
  const buttonClass = `w-full flex rounded-md items-center justify-between gap-2 px-2 py-1.5 text-sm outline-hidden focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-inset ${
    isDisabled
