...
- **GitHub private vulnerability reporting** (preferred): use the [Report a vulnerability](https://github.com/chiriapp/chiri/security/advisories/new) form on the repository's Security tab.
...
Once a fix is available, the vulnerability will be disclosed through a [GitHub security advisory](https://github.com/chiriapp/chiri/security/advisories) on the repository, and credit will be given to the reporter unless they request otherwise.
